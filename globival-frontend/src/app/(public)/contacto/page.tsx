...
const ContactSchema = Yup.object().shape({
  ...
  telefono: Yup.string()
    ...
    .min(9, "El numero debe tener al menos 9 digitos")
    .required("El telefono es obligatorio"),
  email: Yup.string()
    .email("Email invalido")
    .required("El email es obligatorio"),
  titulo: Yup.string()
    .min(5, "Titulo demasiado corto")
    .max(100, "Titulo demasiado largo")
    .required("El titulo es obligatorio"),
  mensaje: Yup.string()
    .min(10, "Mensaje demasiado corto")
    .max(500, "Mensaje demasiado largo")
    .required("El mensaje es obligatorio"),
  categoria: Yup.string().required("Selecciona una categoria"),
});

const categorias = [
  "Detalles para cumpleanos",
...
export default function ContactoPage() {
  ...
  useEffect(() => {
    document.title = "Contacto | Globival Detalles";
  }, []);
